	...
	<f:view>
		...
		<div class="nav-bar">
			<div class="container">
				<ul class="nav">
					<h:form id="links">
						<li><a href="professor.jsp">Home</a></li>
